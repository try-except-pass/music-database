...
for artist in my_artists_albums:
    for album in my_artists_albums[artist]:
        ...
        try:
            x = band_discography_low_case[artist].index(album_low)
            band_discography[artist].pop(x)   
        except:
            pass
        try:
            x = band_singles_low_case[artist].index(album_low)
...
os.remove("My Artists_Albums.pickle")
os.remove("Band Discography.pickle")
os.remove("Band Discography_low_case.pickle")
os.remove("Band Singles.pickle")
os.remove("Band Singles_low_case.pickle")        
print("Done")